...
class LoyaltyUsedView extends StatelessWidget {
  LoyaltyUsedView({Key? key}) : super(key: key);
              ...
              child: Obx(
                () => SingleChildScrollView(
                  child: Column(
                      ...
                      children: myBookingController.loyaltyUsed.value.isEmpty
                          ? []
                          : [
                              ...myBookingController.loyaltyUsed.value
                                  .map((e) => LoyaltyCard(
                                        date: e.usageDate == null
                                            ? ""
                                            : DateFormat.yMMMMd()
                                                .format(e.usageDate!),
                                        title: e.hotelName!,
